      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        {config && (
          <div className="text-center mb-6">
            <h2 className="text-lg font-bold mb-2" style={{ color: themeColor }}>
              {config.icon} {config.name}
            </h2>
            <p className="text-gray-600 text-sm mb-1">{config.address}</p>
